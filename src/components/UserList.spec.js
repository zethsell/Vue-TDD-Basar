...
describe('User List', () => {
  describe('Interations', () => {
    ...
    it('does not display previous page link at last page', async () => {
      await setup()
      await screen.findByText('user1')
    ...
    it('displays previous after clicking previous page link', async () => {
      await setup()
      await screen.findByText('user1')
      await userEvent.click(screen.queryByText('next >'))
      await screen.findByText('user4')
  ...
  describe('Internationalization', () => {
    ...
    it('display header and navigation links in portuguese after selectin that language', async () => {
      await setup()
      await screen.findByText('user1')
      await userEvent.click(screen.queryByText('next >'))
      await screen.findByText('user4')
